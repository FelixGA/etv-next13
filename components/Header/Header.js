...
const Header = () => {
  ...
  return (
    <div className="relative print:hidden ">
      <div className=" sticky top-0 z-30 bg-blue-darker flex flex-row justify-between items-center h-24 w-full 2xl:px-40">
        <Link href={`/`} passHref>
      ...
      <div
        ...
        className="ham-menu-container  lg:hidden  absolute top-9 right-6 z-40 "
      >
        <div className="menu">
