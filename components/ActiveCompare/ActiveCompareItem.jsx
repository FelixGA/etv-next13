...
export default function ActiveCompareItem(props) {
  return (
    <div className="">
      ...
      >
        {/* IMAGE + HEADING */}
        <div className="bg-grey-lighter lg:h-96 absolute w-full top-0"></div>
        <div className="w-48 h-44 lg:w-80 lg:h-72 xl:w-[85%] ml-8 ">
          <Image
        ...
        <div className="hidden lg:flex pt-20 mr-24">
          <TestResult />
        </div>
        ...
        <div className=" relative top-0 lg:top-2">
          ...
          <div className="ninth-category h-10">
            <h3 className="ninth-category-title text-sm lg:text-lg h-10 pl-8 bg-white lg:bg-grey-lighter w-full text-[#2C3F53] flex items-center">
              fgfrsg
            </h3>
          </div>
