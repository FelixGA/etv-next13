    ...
    <>
      {props.open && (
        <>
          ...
          />
          <div className="fixed z-50 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col  bg-grey-lighter rounded-xl pb-8 max-w-screen max-h-screen overflow-y-hidden">
