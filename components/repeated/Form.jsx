...
export default function Form(props) {
  ...
  return (
    <div className="flex justify-center items-center flex-col m-w-[300px]">
      <div className="pt-2 sm:pt-8 flex justify-center items-center">
        <p className="text-sm sm:text-xl md:text-2xl font-bold w-2/3 text-center px-4">
      ...
      <form
        ...
        className="flex flex-col  w-fit bg-white rounded-md p-8 shadow-lg"
      >
        <TextInput
