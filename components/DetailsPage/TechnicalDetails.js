...
const TechnicalDetails = ({ carItem }) => {
  ...
  return (
    <div className="w-full flex flex-col justify-center items-start lg:pt-12 sm:px-4 py-8 ">
      <h3 className="text-black-darkest font-bold py-2 text-2xl lg:text-3xl pl-4">
        Technische Daten
      </h3>
