const Basics = ({ basics, carItem }) => {
  return (
    <section className="w-full lg:w-1/3 print:w-60">
      ...
      <div className="flex flex-col w-full text-blue-extra">
        <div className="flex flex-row flex-1 bg-grey-lighter">
          <p className="flex items-center w-1/2 py-1 pl-4 h-14 text-md print:text-[8px]  print:pt-2 ">
            Klasse:
          </p>
        ...
        {basics?.map((item, index) => (
          <div
            ...
            className={
              index % 2 !== 0
                ? "flex flex-1 bg-grey-lighter print:p-0 print:h-auto	 "
                : "flex flex-1 print:p-0 print:h-auto	"
            }
          >
            <p className="flex items-center w-1/2 py-1 pl-4 h-14 text-md print:text-[8px]  	">
              {item.key}
            </p>
